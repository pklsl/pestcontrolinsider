---
title: "How to Get Rid of Termites: Treatment Options and Cost"
description: "Compare termite treatment options — liquid soil treatments, bait systems, and fumigation — with real cost estimates and guidance on which to choose."
pubDate: 2026-04-19
...
**How it works:**
Termidor uses a "transfer effect" — termites that contact the treated soil don't die immediately. Instead, they carry the active ingredient back to the colony and transmit it to other workers through contact and grooming. This results in colony elimination, not just barrier protection.

**Application process:**
1. Trench around the exterior foundation (typically 6 inches wide, 6 inches deep)
2. Inject termiticide into the trench at specified intervals
3. Backfill the trench
4. Drill through interior concrete slabs if necessary to treat soil beneath
5. Treat crawl spaces if present
...
**How they work:**
Bait stations contain a wood-based monitoring device that is checked periodically. When termite activity is detected, the wood is replaced with an active bait matrix. Workers consume and share the bait, leading to colony elimination over several months.
...
**How it works:**
1. A tent of tarps is placed over the entire structure
2. Sulfuryl fluoride gas is pumped inside to lethal concentrations
3. The structure is sealed for 24–72 hours
4. The tent is removed and the structure ventilated for a day before re-entry
5. The gas leaves no residue — it dissipates completely
...
1. Inspect the interior and exterior for signs of termites and damage
2. Identify the termite species
3. Assess the extent and severity of the infestation
4. Recommend a treatment approach
5. Provide a written report documenting findings
