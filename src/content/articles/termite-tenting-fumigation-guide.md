---
title: "Termite Tenting (Fumigation) Guide: Process, Cost, and Preparation"
description: "Everything you need to know about termite tenting — what to expect during fumigation, how to prepare, how much it costs, and when it's necessary."
pubDate: 2026-04-19
...
1. **Tenting:** Fumigators cover the entire structure with large tarps anchored to the ground. All gaps are sealed. The process can take 4–6 hours.
2. **Warning agent injection:** Chloropicrin (a tear-gas-like warning agent) is pumped in first to ensure no one remains inside accidentally.
3. **Gas introduction:** Sulfuryl fluoride is introduced to achieve the target concentration (oz. per 1,000 cubic feet) for the required duration. The concentration and time required depend on temperature — colder conditions require longer exposure.
4. **Monitoring:** Technicians monitor gas concentrations throughout treatment.
5. **Aeration:** After the required exposure time, the tarps are opened. Large fans ventilate the structure for several hours.
6. **Clearance testing:** A certified fumigator uses gas detection equipment to confirm sulfuryl fluoride levels are below 1 ppm — the EPA-established safe re-entry level.
