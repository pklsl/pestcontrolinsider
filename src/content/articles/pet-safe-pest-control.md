---
title: "Pet-Safe Pest Control: What to Use and What to Avoid"
description: "A guide to pet-safe pest control products and methods — including chemicals that are dangerous to dogs and cats, and the best safer alternatives."
pubDate: 2026-04-19
...
| Product | Dogs | Cats | Notes |
|---|---|---|---|
| TERRO Borax Bait | Generally safe | Generally safe | Keep from chewing stations |
| Food-grade DE | Safe | Safe | Dust during application |
| Permethrin spray | Safe | TOXIC | Keep cats away from treated areas |
| Permethrin dog flea products | Safe | TOXIC | Never apply to cats |
| Metaldehyde slug bait | Toxic | Toxic | Use iron phosphate instead |
| Anticoagulant rodenticide | Risk | Risk | Secondary poisoning from rodents |
| Snap traps (open) | Risk | Risk | Use in inaccessible locations |
| Electronic traps | Safe | Safe | Must be inside chamber for shock |
| Wondercide spray | Generally safe | Generally safe | Check specific product |
