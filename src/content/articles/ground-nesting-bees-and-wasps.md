---
title: "Ground Nesting Bees and Wasps: ID, Ecological Role, and When to Treat"
description: "Learn to identify ground-nesting bees and wasps — including mining bees, digger wasps, and yellowjackets — and understand when treatment is warranted vs. unnecessary."
pubDate: 2026-04-19
...
1. Identify the nest entrance during daylight, but treat after dark
2. Apply dust insecticide (**Delta Dust** — deltamethrin, or **Drione Dust** — pyrethrins + silica) directly into the entrance using a duster
3. Back away immediately — do NOT stand over the entrance
4. The dust coats returning workers and is spread into the nest
5. Leave the entrance open for 48–72 hours to allow maximum dust transfer
6. After activity stops, plug the entrance
